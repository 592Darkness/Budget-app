  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-24 lg:pb-8 animate-in fade-in duration-300">
      <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-app-text tracking-tight">AI Advisor</h1>
          <p className="text-app-muted mt-1">Get personalized financial insights and tips</p>
        </div>
        <button
          onClick={getAdvice}
          disabled={loading}
          className="flex items-center justify-center gap-2 bg-[#6366F1] hover:bg-[#4F46E5] disabled:opacity-50 disabled:cursor-not-allowed text-app-text px-6 py-3 rounded-2xl font-bold transition-colors shadow-lg shadow-[#6366F1]/20"
        >
      ...
      <div className="bg-app-card rounded-[2rem] border border-app-border overflow-hidden p-6 md:p-8 min-h-[300px]">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-12 text-app-muted space-y-4 h-full">
          ...
          <div className="text-center py-12 text-app-muted h-full flex flex-col items-center justify-center">
            <Sparkles size={48} className="mx-auto mb-4 opacity-20" />
            <p className="text-lg font-medium text-app-muted">Ready for some financial wisdom?</p>
