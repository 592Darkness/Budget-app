...
export const ConfirmModal: React.FC<ConfirmModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      <div className="bg-[#141414] rounded-[2rem] shadow-2xl w-full max-w-sm overflow-hidden animate-in fade-in zoom-in duration-200 border border-white/5">
        <div className="p-6">
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              className={`w-full py-4 text-white rounded-2xl font-bold text-lg transition-colors shadow-lg ${
                isDestructive 
            ...
            <button
              onClick={onCancel}
              className="w-full py-4 bg-white/5 hover:bg-white/10 text-white rounded-2xl font-bold text-lg transition-colors"
            >
              {cancelText}
            </button>
          </div>
